...
$config = str_replace("reparaciones.php", "config.php", $_SERVER['SCRIPT_FILENAME']);
require_once($config);
...
$query = "SELECT * FROM servicios WHERE tipo_servicio IN ('reparación de bicicletas', 'reparación general') AND id_user =" . $_SESSION['id_user'];
$result = mysqli_query($conn, $query);
?>
...
<body class="p-5 m-5 border-0 bd-example container">
    <div class="container">
        <div class="alert alert-info" role="alert">
            <h1 class="text-center">Reservas reparaciones:</h1>
        </div>
