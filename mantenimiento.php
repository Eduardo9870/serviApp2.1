...
$config = str_replace("mantenimiento.php", "config.php", $_SERVER['SCRIPT_FILENAME']);
require_once($config);
...
$query = "SELECT * FROM servicios WHERE tipo_servicio IN ('mantenimiento de automóviles', 'mantenimiento de bicicletas') AND id_user =" . $_SESSION['id_user'];
$result = mysqli_query($conn, $query);
?>
